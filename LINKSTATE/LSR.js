...
class Router {
    ...
    // Checks Time to Live for Each Router
    toDiscard(packet) {
    ...
    // Checks Ticks on Connected Routers
    check() {
        for (var key in this.connectedRouters) {
        ...
        fs.readFile(path.join(__dirname, 'infile.dat'), (err, input) => {
            ...
            while (!false) {
                ...
                if (userChoice === 'c') {
                    ...
                    if (this.routerList[userChoice[1]] === undefined) {
                    ...
                    if (this.routerList[userChoice[1]] === undefined) {
                        ...
                        console.log('Router ' + userChoice[1] + ' n=wull be shut down with the next Continue command\n')
                    } 
                }
                    ...
                    if (this.routerList[userChoice[1]] === undefined) {
                        ...
                        console.log('Router ' + userChoice[1] + ' will be available in the next Continue command\n')
                    }
                }
                else {
...
console.log('***************  LINK STATE ROUTING  ***************\n\n')
main.init();
